import{t as e}from"./expandInfo-CJmdp-j_.js";import{t as n}from"./fieldsInfo-Bh9QN0Kd.js";import{t as r}from"./filterSyntax-coc7N6E3.js";function i(i){let a=app.utils.getApiExampleURL(),o=i.listRule===null,s={collectionId:i.id,collectionName:i.name},c=[{title:200,value:JSON.stringify({page:1,perPage:30,totalPages:1,totalItems:2,items:[Object.assign(s,app.utils.getDummyFieldsData(i)),Object.assign(s,app.utils.getDummyFieldsData(i))]},null,2)},{title:400,value:`
                {
                  "status": 400,
