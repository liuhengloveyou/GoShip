import{t as e}from"./expandInfo-CJmdp-j_.js";import{t as n}from"./fieldsInfo-Bh9QN0Kd.js";function r(r){let i=app.utils.getApiExampleURL(),a=r.viewRule===null,o={collectionId:r.id,collectionName:r.name},s=[{title:200,value:JSON.stringify(Object.assign(o,app.utils.getDummyFieldsData(r)),null,2)}];return a&&s.push({title:403,value:`
                {
                  "status": 403,
